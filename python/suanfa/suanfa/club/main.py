...
if __name__ == '__main__':
    ...
    # 层次聚类
    club = AgglomerativeClustering(k)
    club_labels = club.fit_predict(scaled_data)
    club_score = silhouette_score(scaled_data, club_labels)

    # 将聚类结果存入新列

    #data['CLUB_labels'] = club_labels
    #data.to_excel('output.xlsx', index=False)


    print('result',club_labels)
