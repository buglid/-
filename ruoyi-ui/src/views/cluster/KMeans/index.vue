<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="120px">
      ...
      <el-form-item>
        <el-button type="primary" icon="el-icon-search" size="mini" @click="showPay">KMeans开始聚类</el-button>
...
export default {
  ...
  methods: {
    ...
    handleQuery() {
      ...
      // console.log("KMeans Index");
      this.$router.push({name:'BoxDiagram',params:{...this.addDateRange(p, this.dateRange),title:'KMeans盒图',path:'KMeans'}})
    },
    /** 重置按钮操作 */
    resetQuery() {
