<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="120px">
      ...
      <el-form-item label="半径" prop="eps">
        <el-input v-model="queryParams.eps" placeholder="默认值为19.9" clearable :style="{width: '100%'}">
        </el-input>
      </el-form-item>

      <el-form-item label="圆内点数" prop="min_samples">
        <el-input v-model="queryParams.min_samples" placeholder="默认值为12" clearable :style="{width: '100%'}">
        </el-input>
      </el-form-item>

      <el-form-item>
        <el-button type="primary" icon="el-icon-search" size="mini" @click="showPay">DBSCAN开始聚类</el-button>
  ...
  methods: {
    ...
    handleQuery() {
      ...
      const p = {
        ...
        // eps: this.queryParams.eps,
        // min_samples: this.queryParams.min_samples
      }
      // console.log("@queryParams",p);
      // console.log("DBSCAN Index");
      this.$router.push({name:'BoxDiagram',params:{...this.addDateRange(p, this.dateRange),title:'DBSCAN盒图',path:'DBSCAN'}})
    },
    /** 重置按钮操作 */
    resetQuery() {
