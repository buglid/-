<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="120px">
      ...
      <el-form-item label="lamb" prop="lamb">
        <el-input v-model="queryParams.lamb" placeholder="默认值为0.001" clearable :style="{width: '100%'}">
        </el-input>
      </el-form-item>
  ...
  methods: {
    ...
    handleQuery() {
      ...
      const p = {
        ...
        lamb:this.queryParams.lamb
      }
      // console.log("@queryParams",p)
      this.$router.push({name:'BoxDiagram',params:{...this.addDateRange(p, this.dateRange),title:'LRR盒图',path:'lrr'}})
    },
    /** 重置按钮操作 */
    resetQuery() {
