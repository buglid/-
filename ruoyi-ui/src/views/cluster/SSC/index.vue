<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="120px">
      ...
      <el-form-item label="噪声约束参数" prop="lmbda">
        <el-input v-model="queryParams.lmbda" placeholder="默认值为0.001" clearable :style="{width: '100%'}">
        </el-input>
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    ...
    handleQuery() {
      ...
      const p = {
        ...
        lmbda:this.queryParams.lmbda
      }
      // console.log("@queryParams",p)
      // console.log("SSC Index");
      this.$router.push({name:'BoxDiagram',params:{...this.addDateRange(p, this.dateRange),title:'SSC盒图',path:'ssc'}})
    },
    /** 重置按钮操作 */
    resetQuery() {
